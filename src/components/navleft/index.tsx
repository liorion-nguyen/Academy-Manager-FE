...
import { StyleBoxItem, StyleMenu, StyleMenuItem } from "./style-mui";
        ...
        >
            ...
            >
                ...
                <StyleMenuItem>
                    ...
                    <FormControlLabel
                        onChange={(e: any) => {
                            localStorage.setItem('dark', JSON.stringify(e.target.checked));
                            setDark(e.target.checked);
                        }}
                        sx={{ margin: '0 !important', ".MuiSwitch-root": { margin: '0 !important' } }}
                        control={<MaterialUISwitch sx={{ m: 1 }} checked={dark} />}
                        label=""
                    />
                </StyleMenuItem>
                <StyleMenuItem>
